...
![image](https://segmentfault.com/img/remote/1460000017527315?w=319&h=149)

上图表示一个坑一个萝卜的内存读取方式。但实际上 CPU 并不会以一个一个字节去读取和写入内存。相反 CPU 读取内存是**一块一块读取**的，块的大小可以为 2、4、6、8、16 字节等大小。块大小我们称其为**内存访问粒度**。如下图：

![image](https://segmentfault.com/img/remote/1460000017527316?w=424&h=149)
...
![image](https://segmentfault.com/img/remote/1460000017527317?w=574&h=424)
...
- [Data structure alignment](https://link.segmentfault.com/?url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FData_structure_alignment)
- [Data alignment](https://link.segmentfault.com/?url=https%3A%2F%2Fwww.ibm.com%2Fdeveloperworks%2Flibrary%2Fpa-dalign%2F)